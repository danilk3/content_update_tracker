...
public class StackoverflowLinkInfoRecord extends UpdatableRecordImpl<StackoverflowLinkInfoRecord> implements Record10<Integer, Long, Long, String[], Boolean, Long, Long, Integer, OffsetDateTime, String> {
    ...
    @Override
    public StackoverflowLinkInfoRecord values(Integer value1, Long value2, Long value3, String[] value4, Boolean value5, Long value6, Long value7, Integer value8, OffsetDateTime value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StackoverflowLinkInfoRecord(Integer id, Long questionId, Long linkId, String[] tags, Boolean isAnswered, Long viewCount, Long answerCount, Integer score, OffsetDateTime creationDate, String title) {
        super(StackoverflowLinkInfo.STACKOVERFLOW_LINK_INFO);
