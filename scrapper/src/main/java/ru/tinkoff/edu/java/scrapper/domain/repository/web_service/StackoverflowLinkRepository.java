...
public class StackoverflowLinkRepository implements UpdatableRepository<StackoverflowLink, StackoverflowItems> {
    ...
    public List<StackoverflowLink> findOldUpdated() {
        return jdbcTemplate.query(
                """
                        select s.id, l.link_id, s.question_id, s.tags, s.is_answered, s.view_count, s.answer_count, s.score, s.creation_date, s.title, l.url, l.tg_chat_id
    ...
    public StackoverflowLink update(StackoverflowItems response, Long linkId) {
        return jdbcTemplate.queryForObject(
                """
                        ...
                        set question_id = :questionId, tags = :tags, is_answered = :isAnswered, view_count = :viewCount, answer_count = :answerCount, score = :score, title = :title
