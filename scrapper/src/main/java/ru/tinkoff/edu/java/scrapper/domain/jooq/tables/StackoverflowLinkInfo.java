...
public class StackoverflowLinkInfo extends TableImpl<StackoverflowLinkInfoRecord> {
     ...
     */
    public final TableField<StackoverflowLinkInfoRecord, Integer> ID =
     ...
     */
    public final TableField<StackoverflowLinkInfoRecord, Long> QUESTION_ID =
     ...
     */
    public final TableField<StackoverflowLinkInfoRecord, String[]> TAGS =
        createField(DSL.name("tags"), SQLDataType.CLOB.getArrayDataType(), this, "");

    /**
     * The column <code>public.stackoverflow_link_info.is_answered</code>.
     */
    public final TableField<StackoverflowLinkInfoRecord, Boolean> IS_ANSWERED =
        createField(DSL.name("is_answered"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>public.stackoverflow_link_info.view_count</code>.
     */
    public final TableField<StackoverflowLinkInfoRecord, Long> VIEW_COUNT =
        createField(DSL.name("view_count"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.stackoverflow_link_info.answer_count</code>.
     */
    public final TableField<StackoverflowLinkInfoRecord, Long> ANSWER_COUNT =
     ...
     */
    public final TableField<StackoverflowLinkInfoRecord, Integer> SCORE =
     ...
     */
    public final TableField<StackoverflowLinkInfoRecord, OffsetDateTime> CREATION_DATE =
        createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>public.stackoverflow_link_info.title</code>.
     */
    public final TableField<StackoverflowLinkInfoRecord, String> TITLE =
